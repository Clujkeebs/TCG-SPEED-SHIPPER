...
const suites = ['signup.test.js', 'checkout.test.js', 'webhook-signature.test.js', 'referral.test.js', 'free-promo.test.js', 'affiliate.test.js', 'csv-parser.test.js', 'admin.test.js'];
let failed = 0;
